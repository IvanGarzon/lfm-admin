...
export const InvoiceItemCreateManyProductInputSchema: z.ZodType<Prisma.InvoiceItemCreateManyProductInput> = z.strictObject({
  id: z.cuid().optional(),
  invoiceId: z.string(),
...
export default InvoiceItemCreateManyProductInputSchema;
