...
import { QuoteItemAttachmentUncheckedUpdateManyWithoutQuoteItemNestedInputSchema } from './QuoteItemAttachmentUncheckedUpdateManyWithoutQuoteItemNestedInputSchema';
...
export const QuoteItemUncheckedUpdateWithoutProductInputSchema: z.ZodType<Prisma.QuoteItemUncheckedUpdateWithoutProductInput> = z.strictObject({
  ...
  quoteId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  attachments: z.lazy(() => QuoteItemAttachmentUncheckedUpdateManyWithoutQuoteItemNestedInputSchema).optional(),
});

export default QuoteItemUncheckedUpdateWithoutProductInputSchema;
