...
import { QuoteUpdateOneRequiredWithoutAttachmentsNestedInputSchema } from './QuoteUpdateOneRequiredWithoutAttachmentsNestedInputSchema';

export const QuoteAttachmentUpdateInputSchema: z.ZodType<Prisma.QuoteAttachmentUpdateInput> = z.strictObject({
  ...
  quote: z.lazy(() => QuoteUpdateOneRequiredWithoutAttachmentsNestedInputSchema).optional(),
});

export default QuoteAttachmentUpdateInputSchema;
