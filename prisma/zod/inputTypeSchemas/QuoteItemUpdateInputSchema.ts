...
import { QuoteUpdateOneRequiredWithoutItemsNestedInputSchema } from './QuoteUpdateOneRequiredWithoutItemsNestedInputSchema';
import { ProductUpdateOneWithoutQuoteItemsNestedInputSchema } from './ProductUpdateOneWithoutQuoteItemsNestedInputSchema';
import { QuoteItemAttachmentUpdateManyWithoutQuoteItemNestedInputSchema } from './QuoteItemAttachmentUpdateManyWithoutQuoteItemNestedInputSchema';
...
export const QuoteItemUpdateInputSchema: z.ZodType<Prisma.QuoteItemUpdateInput> = z.strictObject({
  ...
  attachments: z.lazy(() => QuoteItemAttachmentUpdateManyWithoutQuoteItemNestedInputSchema).optional(),
});

export default QuoteItemUpdateInputSchema;
