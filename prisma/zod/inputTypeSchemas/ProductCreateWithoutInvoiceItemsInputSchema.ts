...
export const ProductCreateWithoutInvoiceItemsInputSchema: z.ZodType<Prisma.ProductCreateWithoutInvoiceItemsInput> = z.strictObject({
  id: z.cuid().optional(),
...
export default ProductCreateWithoutInvoiceItemsInputSchema;
