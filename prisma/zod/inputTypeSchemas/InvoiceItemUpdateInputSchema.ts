...
import { InvoiceUpdateOneRequiredWithoutItemsNestedInputSchema } from './InvoiceUpdateOneRequiredWithoutItemsNestedInputSchema';
import { ProductUpdateOneWithoutInvoiceItemsNestedInputSchema } from './ProductUpdateOneWithoutInvoiceItemsNestedInputSchema';

export const InvoiceItemUpdateInputSchema: z.ZodType<Prisma.InvoiceItemUpdateInput> = z.strictObject({
  ...
  product: z.lazy(() => ProductUpdateOneWithoutInvoiceItemsNestedInputSchema).optional(),
});

export default InvoiceItemUpdateInputSchema;
