...
import { InvoiceItemUncheckedCreateNestedManyWithoutInvoiceInputSchema } from './InvoiceItemUncheckedCreateNestedManyWithoutInvoiceInputSchema';

export const InvoiceUncheckedCreateWithoutCustomerInputSchema: z.ZodType<Prisma.InvoiceUncheckedCreateWithoutCustomerInput> = z.strictObject({
  id: z.cuid().optional(),
