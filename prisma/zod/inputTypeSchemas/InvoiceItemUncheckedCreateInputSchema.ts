...
export const InvoiceItemUncheckedCreateInputSchema: z.ZodType<Prisma.InvoiceItemUncheckedCreateInput> = z.strictObject({
  id: z.cuid().optional(),
  invoiceId: z.string(),
...
export default InvoiceItemUncheckedCreateInputSchema;
