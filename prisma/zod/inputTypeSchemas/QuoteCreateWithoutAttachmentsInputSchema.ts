...
export const QuoteCreateWithoutAttachmentsInputSchema: z.ZodType<Prisma.QuoteCreateWithoutAttachmentsInput> = z.strictObject({
  id: z.cuid().optional(),
...
export default QuoteCreateWithoutAttachmentsInputSchema;
