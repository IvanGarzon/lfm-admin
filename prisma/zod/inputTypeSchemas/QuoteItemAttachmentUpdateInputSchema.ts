...
import { QuoteItemUpdateOneRequiredWithoutAttachmentsNestedInputSchema } from './QuoteItemUpdateOneRequiredWithoutAttachmentsNestedInputSchema';

export const QuoteItemAttachmentUpdateInputSchema: z.ZodType<Prisma.QuoteItemAttachmentUpdateInput> = z.strictObject({
  ...
  quoteItem: z.lazy(() => QuoteItemUpdateOneRequiredWithoutAttachmentsNestedInputSchema).optional(),
});

export default QuoteItemAttachmentUpdateInputSchema;
