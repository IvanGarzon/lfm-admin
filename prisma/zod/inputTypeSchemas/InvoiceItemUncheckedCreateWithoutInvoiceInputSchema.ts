...
export const InvoiceItemUncheckedCreateWithoutInvoiceInputSchema: z.ZodType<Prisma.InvoiceItemUncheckedCreateWithoutInvoiceInput> = z.strictObject({
  id: z.cuid().optional(),
...
export default InvoiceItemUncheckedCreateWithoutInvoiceInputSchema;
