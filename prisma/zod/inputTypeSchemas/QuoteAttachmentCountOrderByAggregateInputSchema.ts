...
export const QuoteAttachmentCountOrderByAggregateInputSchema: z.ZodType<Prisma.QuoteAttachmentCountOrderByAggregateInput> = z.strictObject({
...
export default QuoteAttachmentCountOrderByAggregateInputSchema;
