...
export const QuoteItemCreateWithoutAttachmentsInputSchema: z.ZodType<Prisma.QuoteItemCreateWithoutAttachmentsInput> = z.strictObject({
  id: z.cuid().optional(),
...
export default QuoteItemCreateWithoutAttachmentsInputSchema;
