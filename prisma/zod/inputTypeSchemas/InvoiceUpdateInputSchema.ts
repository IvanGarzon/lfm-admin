...
import { CustomerUpdateOneRequiredWithoutInvoicesNestedInputSchema } from './CustomerUpdateOneRequiredWithoutInvoicesNestedInputSchema';
import { InvoiceItemUpdateManyWithoutInvoiceNestedInputSchema } from './InvoiceItemUpdateManyWithoutInvoiceNestedInputSchema';

export const InvoiceUpdateInputSchema: z.ZodType<Prisma.InvoiceUpdateInput> = z.strictObject({
