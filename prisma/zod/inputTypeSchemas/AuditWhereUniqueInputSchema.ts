...
import { z } from 'zod';
import { AuditWhereInputSchema } from './AuditWhereInputSchema';
...
export const AuditWhereUniqueInputSchema: z.ZodType<Prisma.AuditWhereUniqueInput> = z.object({
  id: z.uuid(),
})
.and(z.strictObject({
  id: z.uuid().optional(),
...
export default AuditWhereUniqueInputSchema;
