...
export const QuoteAttachmentMinOrderByAggregateInputSchema: z.ZodType<Prisma.QuoteAttachmentMinOrderByAggregateInput> = z.strictObject({
...
export default QuoteAttachmentMinOrderByAggregateInputSchema;
