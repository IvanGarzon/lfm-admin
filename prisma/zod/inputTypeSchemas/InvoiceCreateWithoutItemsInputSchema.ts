...
export const InvoiceCreateWithoutItemsInputSchema: z.ZodType<Prisma.InvoiceCreateWithoutItemsInput> = z.strictObject({
  id: z.cuid().optional(),
...
export default InvoiceCreateWithoutItemsInputSchema;
