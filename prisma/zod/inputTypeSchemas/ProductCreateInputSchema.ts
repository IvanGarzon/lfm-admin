...
import { InvoiceItemCreateNestedManyWithoutProductInputSchema } from './InvoiceItemCreateNestedManyWithoutProductInputSchema';
import { QuoteItemCreateNestedManyWithoutProductInputSchema } from './QuoteItemCreateNestedManyWithoutProductInputSchema';
...
export const ProductCreateInputSchema: z.ZodType<Prisma.ProductCreateInput> = z.strictObject({
  ...
  invoiceItems: z.lazy(() => InvoiceItemCreateNestedManyWithoutProductInputSchema).optional(),
