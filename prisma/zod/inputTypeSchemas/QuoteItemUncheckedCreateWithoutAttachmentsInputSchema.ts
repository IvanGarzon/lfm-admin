...
export const QuoteItemUncheckedCreateWithoutAttachmentsInputSchema: z.ZodType<Prisma.QuoteItemUncheckedCreateWithoutAttachmentsInput> = z.strictObject({
  id: z.cuid().optional(),
  quoteId: z.string(),
...
export default QuoteItemUncheckedCreateWithoutAttachmentsInputSchema;
