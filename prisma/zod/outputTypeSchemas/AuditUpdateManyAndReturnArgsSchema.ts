...
export const AuditUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.AuditUpdateManyAndReturnArgs> = z.object({
...
export default AuditUpdateManyAndReturnArgsSchema;
