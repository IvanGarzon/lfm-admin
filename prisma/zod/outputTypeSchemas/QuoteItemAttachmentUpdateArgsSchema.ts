...
export const QuoteItemAttachmentUpdateArgsSchema: z.ZodType<Prisma.QuoteItemAttachmentUpdateArgs> = z.object({
  select: QuoteItemAttachmentSelectSchema.optional(),
  include: z.lazy(() => QuoteItemAttachmentIncludeSchema).optional(),
  data: z.union([ QuoteItemAttachmentUpdateInputSchema, QuoteItemAttachmentUncheckedUpdateInputSchema ]),
  where: QuoteItemAttachmentWhereUniqueInputSchema, 
}).strict();

export default QuoteItemAttachmentUpdateArgsSchema;
