...
import { QuoteItemAttachmentUpdateInputSchema } from '../inputTypeSchemas/QuoteItemAttachmentUpdateInputSchema'
import { QuoteItemAttachmentUncheckedUpdateInputSchema } from '../inputTypeSchemas/QuoteItemAttachmentUncheckedUpdateInputSchema'
...
export const QuoteItemAttachmentUpsertArgsSchema: z.ZodType<Prisma.QuoteItemAttachmentUpsertArgs> = z.object({
  ...
  create: z.union([ QuoteItemAttachmentCreateInputSchema, QuoteItemAttachmentUncheckedCreateInputSchema ]),
  update: z.union([ QuoteItemAttachmentUpdateInputSchema, QuoteItemAttachmentUncheckedUpdateInputSchema ]),
}).strict();

export default QuoteItemAttachmentUpsertArgsSchema;
