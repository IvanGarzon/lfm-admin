...
export const QuoteItemAttachmentFindManyArgsSchema: z.ZodType<Prisma.QuoteItemAttachmentFindManyArgs> = z.object({
...
export default QuoteItemAttachmentFindManyArgsSchema;
