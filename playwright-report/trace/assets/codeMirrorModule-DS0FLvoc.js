              ...
              moveV: yt(function (r, i) {
                ...
                if (
                  (l.extendSelectionsBy(function (h) {
                    ...
                    var D = da(o, x, r, i);
                    return (
                      i == 'page' && h == l.sel.primary() && ji(o, Qn(o, D, 'div').top - x.top), D
                    );
                  }, Pe),
                  a.length)
                )
          ...
          b.defineMode('css', function (J, P) {
            ...
            function qe(E) {
              return function (ee, K) {
                ...
                return (
                  (me == E || (!ze && E != ')')) && (K.tokenize = null), ve('string', 'string')
                );
              };
            }
            function $e(E, ee) {
            ...
            function Pe(E, ee, K, ze) {
              return (
                (E.context = new dt(K, ee.indentation() + (ze === !1 ? 0 : F), E.context)), K
              );
            }
            function _e(E) {
        ...
        (function (b) {
          ...
          (b.defineMode('xml', function (te, oe) {
            ...
            function A(c, T) {
              ...
              if (C == '>' || (C == '/' && c.eat('>')))
                return (
                  (T.tokenize = R), (ne = C == '>' ? 'endTag' : 'selfcloseTag'), 'tag bracket'
                );
        ...
        (function (b) {
          ...
          (b.defineMode('python', function (I, Y) {
            ...
            function q(T, C) {
              ...
              if ((g && (C.indent = T.indentation()), g && Q(C).type == 'py')) {
                ...
                if (T.eatSpace()) {
                  var j = T.indentation();
                  return (
                    j > y ? P(C) : j < y && F(T, C) && T.peek() != '#' && (C.errorToken = !0), null
                  );
                } else {
                  var de = p(T, C);
            ...
            function G(T, C) {
              ...
              return (
                C.dedent && T.eol() && Q(C).type == 'py' && C.scopes.length > 1 && C.scopes.pop(), g
              );
            }
            var c = {
          ...
          function Q(S, R) {
            return function (A, $) {
              if ($.pending) {
                ...
                return (
                  $.pending.length == 0 && ($.pending = null), (A.pos += ue.text.length), ue.token
                );
              }
              if ($.local)
