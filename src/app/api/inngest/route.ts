 ...
 *
 * Note: We cache the functions to prevent recreation on hot reload in development.
 * This avoids MaxListenersExceededWarning from accumulating process exit listeners.
 */
let cachedFunctions: ReturnType<typeof getAllInngestFunctions> | null = null;

function getFunctions() {
  if (!cachedFunctions) {
    cachedFunctions = getAllInngestFunctions();
  }
