 ...
 */
export const createCustomer = withTenantPermission<CreateCustomerInput, { id: string }>(
  'canManageCustomers',
  async (ctx, data) => {
    try {
 ...
 */
export const updateCustomer = withTenantPermission<UpdateCustomerInput, { id: string }>(
  'canManageCustomers',
  async (ctx, data) => {
    try {
 ...
 */
export const deleteCustomer = withTenantPermission<DeleteCustomerInput, { id: string }>(
  'canManageCustomers',
  async (ctx, data) => {
    try {
