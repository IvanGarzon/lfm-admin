...
describe('Products Schemas', () => {
  ...
  describe('UpdateProductSchema', () => {
    it('accepts a valid update payload', () => {
      expect(() => UpdateProductSchema.parse({ ...validInput, id: TEST_PRODUCT_ID })).not.toThrow();
    });
    ...
    it('rejects an invalid id format', () => {
      const result = UpdateProductSchema.safeParse({ ...validInput, id: 'not-valid' });
      expect(result.success).toBe(false);
    });
  ...
  describe('DeleteProductSchema', () => {
    it('accepts a valid CUID', () => {
      expect(() => DeleteProductSchema.parse({ id: TEST_PRODUCT_ID })).not.toThrow();
    });
